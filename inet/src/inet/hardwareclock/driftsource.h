...
namespace inet {
    ...
    public:
        ...
        BoundedDriftVariation(const cPar& distribution, double max_drift_variation, double start_value,  const simtime_t& tint,const cPar& max_variation);
    };
}
#endif
